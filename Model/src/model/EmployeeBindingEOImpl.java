...
// ---    Mon Sep 21 13:54:06 IST 2020
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class EmployeeBindingEOImpl extends EntityImpl {
    /**
    ...
    public static final int MANAGERIDEMPLOYEEBINDINGEO = AttributesEnum.ManagerIdEmployeeBindingEO.index();
    public static final int EMPLOYEEBINDINGEO = AttributesEnum.EmployeeBindingEO.index();
    ...
    /**
     * @return the associated entity EmployeeBindingEOImpl.
     */
    public EmployeeBindingEOImpl getManagerIdEmployeeBindingEO() {
        return (EmployeeBindingEOImpl) getAttributeInternal(MANAGERIDEMPLOYEEBINDINGEO);
    }

    /**
     * Sets <code>value</code> as the associated entity EmployeeBindingEOImpl.
     */
    public void setManagerIdEmployeeBindingEO(EmployeeBindingEOImpl value) {
        setAttributeInternal(MANAGERIDEMPLOYEEBINDINGEO, value);
    }

    /**
     * @return the associated entity oracle.jbo.RowIterator.
     */
    public RowIterator getEmployeeBindingEO() {
        return (RowIterator) getAttributeInternal(EMPLOYEEBINDINGEO);
    }
     ...
     * @return the associated entity oracle.jbo.server.EntityImpl.
     */
    public EntityImpl getEmployeesEntityObject1() {
        return (EntityImpl) getAttributeInternal(EMPLOYEESENTITYOBJECT1);
    }

    /**
     * Sets <code>value</code> as the associated entity oracle.jbo.server.EntityImpl.
     */
    public void setEmployeesEntityObject1(EntityImpl value) {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("model.EmployeeBindingEO");
    }
